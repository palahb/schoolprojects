 ...
 * 
 * This program is the implementation of the Client of the Part B of the CmpE 322 Project 1 in the 
 * Fall 2021 semester.
 ...
 */
void
part_b_prog_1(char *blackbox, char* outfile, int num1, int num2, char *host)
{
	CLIENT *clnt; // Client
	 ...
	 * 					the RPC function.
	 */
	part_b_result  *result_1;

	/**
	 * The "part_b_1_arg" struct contains the arguments which will be sent to the server. It has three member vars:
	 *  part_b_1_arg.blackbox:	This variable is a string which contains the path of the executable file.
	 * 	part_b_1_arg.num1:		This is an integer which is the first argument of the requested RPC function.
	 *  part_b_1_arg.num2:		This is an integer which is the second argument of the requested RPC function.
	 */
	part_b_struct  part_b_1_arg;

#ifndef	DEBUG
	clnt = clnt_create (host, PART_B_PROG, PART_B_VERS, "udp"); // Creates the client.
	if (clnt == NULL) {
...
main (int argc, char *argv[])
{
	...
	// Client is run:
	part_b_prog_1 (blackbox,outfile,num1,num2,host);
